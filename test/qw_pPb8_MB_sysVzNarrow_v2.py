...
process.QWSC2_3_2_3.maxvz = cms.untracked.double(3)
...
process.QWEvent.fweight = cms.untracked.InputTag('Hijing_8TeV_MB_eff_v4_narrow.root')
...
process.path = cms.Path(process.hltMB*process.eventSelection*process.Noff*process.QWEvent*process.ana)
