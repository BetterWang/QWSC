...
process.vectPhiW220 = process.vectPhiW.clone()
process.vectPhiW250 = process.vectPhiW.clone()
process.vectPhiW280 = process.vectPhiW.clone()
...
process.vectEtaW220 = process.vectEtaW.clone()
process.vectEtaW250 = process.vectEtaW.clone()
process.vectEtaW280 = process.vectEtaW.clone()
...
process.vectPtW220 = process.vectPtW.clone()
...
process.path220 = cms.Path(process.hltHM220*process.eventSelection*process.Noff*process.ppNoffFilter220*process.QWEvent*process.ana * process.mon220)
...
process.path280 = cms.Path(process.hltHM280*process.eventSelection*process.Noff*process.ppNoffFilter280*process.QWEvent*process.ana * process.mon280)
