...
config.General.requestName = 'PAHM0_SC_eff_v3'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qw_pPb8_HM_v1.py'
...
### 1
config.General.requestName = 'PAHM1_SC_eff_v3'
...
### 2
config.General.requestName = 'PAHM2_SC_eff_v3'
...
### 3
config.General.requestName = 'PAHM3_SC_eff_v3'
...
### 4
config.General.requestName = 'PAHM4_SC_eff_v3'
...
### 5
config.General.requestName = 'PAHM5_SC_eff_v3'
...
### 6
config.General.requestName = 'PAHM6_SC_eff_v3'
...
### 7
config.General.requestName = 'PAHM7_SC_eff_v3'
